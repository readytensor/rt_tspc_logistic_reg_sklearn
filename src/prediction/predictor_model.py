...
class TSAnnotator:
    """Logistic Regression Timeseries Annotator.

    This class provides a consistent interface that can be used with other
    TSAnnotator models.
    """

    MODEL_NAME = "Logistic_Regression_Timeseries_Annotator"
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Construct a new Logistic Regression TSAnnotator.
    ...
    def save(self, model_dir_path: str) -> None:
        """Save the Logistic Regression TSAnnotator to disk.
    ...
    def load(cls, model_dir_path: str) -> "TSAnnotator":
        """Load the Logistic Regression TSAnnotator from disk.

        Args:
            model_dir_path (str): Dir path to the saved model.
        Returns:
            TSAnnotator: A new instance of the loaded Logistic Regression TSAnnotator.
        """
